...
<div class="container mt-4">
    <hr>
    <h1 class="display-5">Catálogo de Listas</h1>
    <hr>
    ...
    <script>
        ...
        continueButton.addEventListener("click", function() {
            ...
            window.location.href = "{{ route('listas.create') }}";
        });
    </script>
    <div class="row mb-3">
        <div class="col">
        ...
        <table class="table table-striped table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $lista->curso->fechaInicio}}</td>
                    <td>{{ $lista->horaInicio }}</td>
                    <td>{{ $lista->horaFinal }}</td>
                    <td>{{ $lista->lugar }}</td>
                    <td>{{ $lista->instructor->nombre }}</td>
                    
                    <td><a id="verInformacion" href="{{ route('listas.show', ['lista' => $lista->id]) }}"><svg
                        width="26" height="26" fill="none" stroke="#0055ff" stroke-linecap="round"
                        stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24">
                        <path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8-11-8-11-8z"></path>
                        <path d="M12 9a3 3 0 1 0 0 6 3 3 0 1 0 0-6z"></path>
                    </svg></a>
            </td>
            <td> <a id="pendiente" href="{{ route('listas.edit', ['lista' => $lista->id]) }}"><svg
            ...
            <td> <a id="rechazar" href="{{ route('listas.destroy', ['lista' => $lista->id]) }}"
