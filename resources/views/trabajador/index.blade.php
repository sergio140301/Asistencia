...
@section('contenido')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            }, 3000); // Oculta el mensaje después de 5000 milisegundos (5 segundos)
        });
    </script>

    <div class="container mt-4">
        <hr>
        <h1 class="display-5">Catálogo de Personal</h1>
        <hr>
        ...
        <div class="row mb-3">
            ...
            <div class="col-auto">
                <form action="{{ route('trabajadores.index') }}" method="get" class="d-flex">
        ...
        <div class="table-responsive">
            <table class="table table-striped table-hover">
                ...
                <tbody>
                    @forelse ($trabaja as $trab)
                        <tr>
                            <td>{{ $trab->id }}</td>
                            <td>{{ $trab->nombre . ' ' . $trab->apellidoP . ' ' . $trab->apellidoM }}</td>
                            <td>{{ $trab->rfc }}</td>
                            <td>{{ $trab->departamento->nombreDepto }}</td>
                            <td>{{ $trab->puesto->nombrePuesto }}</td>
                            <td><a id="verInformacion"
                                    href="{{ route('trabajadores.show', ['trabajador' => $trab->id]) }}"><svg width="26"
                            ...
                            <td> <a id="pendiente" href="{{ route('trabajadores.edit', ['trabajador' => $trab->id]) }}"><svg
                            ...
                            <td> <a id="rechazar" href="{{ route('trabajadores.destroy', ['trabajador' => $trab->id]) }}"
