  ...
  @endguest
        ...
        <div class="w3-bar-block">
            ...
            <a href="{{route('index')}}" class="w3-bar-item w3-button w3-padding {{ request()->is('index*') ? 'active' : '' }}"><i class="fa fa-users fa-fw"></i>&nbsp;
                INICIO</a>
            <a href="{{route('trabajadores.index')}}" class="w3-bar-item w3-button w3-padding {{ request()->is('trabajadores*') ? 'active' : '' }}"><i class="fa fa-eye fa-fw"></i>&nbsp;
                PERSONAL</a>
            <a href="{{route('cursos.index')}}" class="w3-bar-item w3-button w3-padding {{ request()->is('cursos*') ? 'active' : '' }}"><i class="fa fa-bullseye fa-fw"></i>&nbsp;
                CURSOS</a>
            <a href="{{route('listas.index')}}" class="w3-bar-item w3-button w3-padding {{ request()->is('listas*') ? 'active' : '' }}"><i class="fa fa-bullseye fa-fw"></i>&nbsp;
                CURSOS 2 </a>
            <a href="{{route('departamentos.index')}}" class="w3-bar-item w3-button w3-padding {{ request()->is('departamentos*') ? 'active' : '' }}"><i class="fa fa-bullseye fa-fw"></i>&nbsp;
                DEPARTAMENTOS</a>
            <a href="{{route('instructores.index')}}" class="w3-bar-item w3-button w3-padding {{ request()->is('instructores*') ? 'active' : '' }}"><i class="fa fa-users fa-fw"></i>&nbsp;
                INSTRUCTORES</a>
