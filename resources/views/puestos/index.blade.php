...
@section('contenido')
    ...
    <div class="container mt-4">
        <hr>
        <h1 class="display-5">Catálogo de Puestos</h1>
        <hr>
        ...
        <script>
            ...
            continueButton.addEventListener("click", function() {
                ...
                window.location.href = "{{ route('puestos.create') }}";
            });
        </script>
        ...
        <div class="row mb-3">
            ...
            <div class="col-auto">
                <form action="{{ route('puestos.index') }}" method="get" class="d-flex">
                ...
                <tbody>
                    @forelse ($puestos as $puesto)
                        <tr>
                            ...
                            <td><a id="verInformacion" href="{{ route('puestos.show', ['puesto' => $puesto->id]) }}"><svg
                            ...
                            <td> <a id="pendiente" href="{{ route('puestos.edit', ['puesto' => $puesto->id]) }}"><svg
                            ...
                            <td> <a id="rechazar" href="{{ route('puestos.destroy', ['puesto' => $puesto->id]) }}"
