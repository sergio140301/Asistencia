...
<div class="container mt-4">
    <hr>
    <h1 class="display-5">Catálogo de Departamentos</h1>
    <hr>
    ...
    <script>
        ...
        continueButton.addEventListener("click", function() {
            ...
            window.location.href = "{{ route('departamentos.create') }}";
        });
    </script>
    <div class="row mb-3">
        <div class="col">
        ...
        <div class="col-auto">
            <form action="{{ route('departamentos.index') }}" method="get" class="d-flex">
                <input type="text" name="txtnombre" class="form-control me-2" placeholder="Buscar por departamento">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a id="verInformacion"
                        href="{{ route('departamentos.show', ['departamento' => $depto->id]) }}"><svg width="26"
                ...
                <td> <a id="pendiente" href="{{ route('departamentos.edit', ['departamento' => $depto->id]) }}"><svg
                ...
                <td> <a id="rechazar" href="{{ route('departamentos.destroy', ['departamento' => $depto->id]) }}"
