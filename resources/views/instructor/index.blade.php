...
@section('contenido')
    ...
    <div class="container mt-4">
        <hr>
        <h1 class="display-5">Catálogo de Instructores</h1>
        <hr>
        ...
        <script>
            ...
            continueButton.addEventListener("click", function() {
                ...
                window.location.href = "{{ route('instructores.create') }}";
            });
        </script>
        <div class="row mb-3">
            <div class="col">
            ...
            <div class="col-auto">
                <form action="{{ route('instructores.index') }}" method="get" class="d-flex">
                ...
                <tbody>
                    @forelse ($inst as $ins)
                        <tr>
                            ...
                            <td>{{ $ins->apellidoM }}</td>
                            <td>{{ $ins->rfc }}</td>
                            <td>{{ $ins->tipoInstructor }}</td>
                            <td><a id="verInformacion"
                                    href="{{ route('instructores.show', ['instructor' => $ins->id]) }}"><svg width="26"
                            ...
                            <td> <a id="pendiente" href="{{ route('instructores.edit', ['instructor' => $ins->id]) }}"><svg
                            ...
                            <td> <a id="rechazar" href="{{ route('instructores.destroy', ['instructor' => $ins->id]) }}"
